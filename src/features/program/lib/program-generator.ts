 ...
 *  we can derive how intense to make each workout day and how many excercises to add/remove
 *  ie. 6 days chosen -> PPL_SIX_DAY_SPLIT -> determined low intensity, descrease rep/set ranges and remove an accessory excercise from a base of 1 compound lift + 4 accessory lifts
 */
const programGenerator = (formData: FormState): GeneratedProgram => {
  ...
  //   order workouts based on EXCERCISE_ORDER
  // 
};
